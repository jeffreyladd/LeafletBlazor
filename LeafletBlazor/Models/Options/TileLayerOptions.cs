namespace LeafletBlazor.Models
{
    public record TileLayerOptions : GridLayerOptions
    {
        ...
        /// </summary>
        public string[] Subdomains { get; init; } = new string[] { "abc" };

        /// <summary>
        /// URL to the tile image to show in place of the tile that failed to load.
        /// </summary>
        public string ErrorTileUrl { get; init; }

        /// <summary>
        /// The zoom number used in tile URLs will be offset with this value.
        /// </summary>
        public double ZoomOffset { get; init; }

        /// <summary>
        /// If true, inverses Y axis numbering for tiles (turn this on for TMS services).
        /// </summary>
        public bool Tms { get; init; } = false;

        /// <summary>
        /// If set to true, the zoom number used in tile URLs will be reversed (maxZoom - zoom instead of zoom)
        /// </summary>
        public bool ZoomReversed { get; init; }

        /// <summary>
        /// If true and user is on a retina display, it will request four tiles of half the specified size and a bigger zoom level in place of one to utilize the high resolution.
        /// </summary>
        public bool DetectRetina { get; init; }
    }
}
