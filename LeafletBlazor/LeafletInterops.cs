...
namespace LeafletBlazor
{
    public static class LeafletInterops
    {
        ...
        public static ValueTask SetMapView(IJSRuntime jsRuntime, string mapId, LatLng center, double zoom, ZoomPanOptions options) => jsRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setMapView", mapId, center, zoom, options);

        public static ValueTask SetMapZoom(IJSRuntime jsRuntime, string mapId, double zoom, ZoomPanOptions options) => jsRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setMapZoom", mapId, zoom, options);

        public static ValueTask SetZoomIn(IJSRuntime jSRuntime, string mapId, double delta, ZoomOptions options) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setZoomIn", mapId, delta, options);

        public static ValueTask SetZoomOut(IJSRuntime jSRuntime, string mapId, double delta, ZoomOptions options) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setZoomOut", mapId, delta, options);

        public static ValueTask SetZoomAround(IJSRuntime jsRuntime, string mapId, LatLng center, double zoom, ZoomOptions options) => jsRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setZoomAround", mapId, center, zoom, options);

        public static ValueTask SetMinZoom(IJSRuntime jSRuntime, string mapId, double zoom) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setMinZoom", mapId, zoom);

        public static ValueTask SetMaxZoom(IJSRuntime jSRuntime, string mapId, double zoom) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.setMaxZoom", mapId, zoom);

        public static ValueTask PanInside(IJSRuntime jSRuntime, string mapId, LatLng latLng) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.panInside", mapId, latLng);

        public static ValueTask InvalidateSize(IJSRuntime jSRuntime, string mapId, ZoomPanOptions options) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.InvalidateSize", mapId, options);

        public static ValueTask Stop(IJSRuntime jSRuntime, string mapId) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.stop", mapId);

        public static ValueTask Remove(IJSRuntime jSRuntime, string mapId) => jSRuntime.InvokeVoidAsync($"{_BaseObjectContainer}.remove", mapId);

        public static ValueTask<LatLng> GetCenter(IJSRuntime jsRuntime, string mapId) => jsRuntime.InvokeAsync<LatLng>($"{_BaseObjectContainer}.getCenter", mapId);

        public static ValueTask<double> GetZoom(IJSRuntime jsRuntime, string mapId) => jsRuntime.InvokeAsync<double>($"{_BaseObjectContainer}.getZoom", mapId);

        public static ValueTask<double> GetMinZoom(IJSRuntime jsRuntime, string mapId) => jsRuntime.InvokeAsync<double>($"{_BaseObjectContainer}.getMinZoom", mapId);

        public static ValueTask<double> GetMaxZoom(IJSRuntime jsRuntime, string mapId) => jsRuntime.InvokeAsync<double>($"{_BaseObjectContainer}.getMaxZoom", mapId);
